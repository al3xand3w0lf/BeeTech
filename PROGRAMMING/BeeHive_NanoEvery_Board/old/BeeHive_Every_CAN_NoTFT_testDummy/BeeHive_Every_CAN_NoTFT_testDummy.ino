...
#define STATIONUMBER 3
#define STATIONNAME  lab101
...
void loop()
{
  ...
  if (CAN_received_flag == true) {                
      ...
      if(STATIONUMBER == 2){
          sendSensorData(  MESSAGE_ID_TEMP1  + stationNumber, 27.13 );
          sendSensorData(  MESSAGE_ID_TEMP2  + stationNumber, 24.13 );
          sendSensorData(  MESSAGE_ID_WEIGHT + stationNumber, 88.1  );
          sendSensorData(  MESSAGE_ID_SOUND  + stationNumber, 87.2 ); 
      }
      else if(STATIONUMBER == 3){
          sendSensorData(  MESSAGE_ID_TEMP1  + stationNumber, 24.13 );
          sendSensorData(  MESSAGE_ID_TEMP2  + stationNumber, 23.13 );
          sendSensorData(  MESSAGE_ID_WEIGHT + stationNumber, 82.1  );
          sendSensorData(  MESSAGE_ID_SOUND  + stationNumber, 83.2 ); 
      }
