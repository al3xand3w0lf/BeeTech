...
const int chipSelect = DEF_SDCARD_CS;
 ...
 // Check to see if the file exists:
  if (SD.exists("config.txt")) {
    ...
    if (myFile) { 
        ...
        result_ptr = strstr(bufferIntern,"dataPoll_intervall");
        if(result_ptr > 0){
           while( *result_ptr != '='){ 
                  result_ptr++;
           }
           ...
           stn_out[i] = 0;
           dataPoll_intervall = atoi(stn_out);    
           Serial.print("dataPoll_intervall = ");
           Serial.println(stn_out);       
        }
        else
          Serial.print("ERROR reading: dataPoll_intervall");                 


        result_ptr = strstr(bufferIntern,"uploadAfterXdatapolls");
        if(result_ptr > 0){
           while( *result_ptr != '='){ 
                  result_ptr++;
           }
           ...
           stn_out[i] = 0;
           uploadAfterXdatapolls = atoi(stn_out);    
           Serial.print("uploadAfterXdatapolls = ");
           Serial.println(stn_out);       
        }
        else
          Serial.print("ERROR reading: uploadAfterXdatapolls");        
...
*/
        ...
        if(result_ptr > 0){
          ...
          Serial.print("ERROR reading: upload_timing"); 
/**/
        ...
        if(result_ptr > 0){
          ...
          Serial.print("ERROR reading: INSERT_SQL"); 
      ...
      // Network connection settings   
        ...
        if(result_ptr > 0){
          ...
          Serial.print("ERROR reading: number_beehives"); 
